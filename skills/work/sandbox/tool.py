...
from skills.work.sandbox import sandbox_tools
import json


async def init_llm_tools(payload: dict):
    return sandbox_tools.init_llm_tools(**payload)
...
async def py_run(payload: dict):
    ...
    return sandbox_tools.py_run(**payload)
...
async def fs_write(payload: dict):
    ...
    return sandbox_tools.fs_write(**payload)


async def fs_read(payload: dict):
    return sandbox_tools.fs_read(**payload)


async def fs_list(payload: dict):
    return sandbox_tools.fs_list(**payload)


async def cmd_run(payload: dict):
    return sandbox_tools.cmd_run(**payload)
